<?php
    ...
    if ($resultado->num_rows>0) {
        ...
        <td><a href='./admin/EliminarU.php?idUsuario=".$fila["idUsuario"]."' class='btn btn-danger'  value='eliminar' name='eliminar' onclick='return ConfirmarEliminar()' ><i class='fa fa-trash'></i></a></td>
    				</tr>";
